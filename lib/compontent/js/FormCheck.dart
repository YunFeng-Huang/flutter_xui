...
//[required]: 是否必填
bool formCheckToast(FormKeyEnum key, value, [info = '', required = false]) {
...
bool checkAllForm(List<CheckFormItem> arr) {
  var a = arr.every((CheckFormItem v) {
    return formCheckToast(v.key, v.value, v.info, v.required);
  });
  return a;
}
