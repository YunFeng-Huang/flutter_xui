...
class XInput extends StatelessWidget {
  ...
  bool? _obscureText;
  XInput({label, labelWidget, labelAlign, labelWidth, labelStyle, padding, radius, hintText, hintStyle, keyboardType, controller, obscureText, validator, textAlign, border, onChanged, contentPadding, required, enabled}) {
    _label = label;
    _padding = padding;
