...
class _GestureZoomBoxState extends State<GestureZoomBox> with TickerProviderStateMixin {
  ...
  _onVerticalDragUpdate(DragUpdateDetails e) {
    setState(() {
      disabled = false;
    });
    var _ = e.localPosition - _offset2;
    var v = (500 - _.dy) / 500;
    if (_.dy > 0 && v > 0) {
      setState(() {
        _scale = v < 0.5 ? 0.5 : v;
    ...
    widget.up(_scale, false);
  }

  _onVerticalDragStart(DragStartDetails e) {
    _offset2 = e.localPosition;
  }
