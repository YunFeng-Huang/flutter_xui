...
class PKCardSkeleton extends StatefulWidget {
  ...
  PKCardSkeleton({this.isCircularImage = true, this.isBottomLinesActive = true});
  @override
  _PKCardSkeletonState createState() => _PKCardSkeletonState();
}

class _PKCardSkeletonState extends State<PKCardSkeleton> with SingleTickerProviderStateMixin {
...
class PKDarkCardSkeleton extends StatefulWidget {
  final bool isCircularImage;
  final bool isBottomLinesActive;
  PKDarkCardSkeleton({this.isCircularImage = true, this.isBottomLinesActive = true});
  @override
  _PKDarkCardSkeletonState createState() => _PKDarkCardSkeletonState();
}

class _PKDarkCardSkeletonState extends State<PKDarkCardSkeleton> with SingleTickerProviderStateMixin {
                ...
                Row(
                  ...
                  children: <Widget>[
                    Container(
                      height: width * 0.13,
                      width: width * 0.13,
                      decoration: myDarkBoxDec(animation, isCircle: widget.isCircularImage),
                    ),
                    SizedBox(
                      width: 20,
                    ),
...
class PKCardProfileSkeleton extends StatefulWidget {
  final bool isCircularImage;
  final bool isBottomLinesActive;
  PKCardProfileSkeleton({this.isCircularImage = true, this.isBottomLinesActive = true});
  @override
  _PKCardProfileSkeletonState createState() => _PKCardProfileSkeletonState();
}

class _PKCardProfileSkeletonState extends State<PKCardProfileSkeleton> with SingleTickerProviderStateMixin {
  AnimationController? _controller;
  Animation<double>? animation;
...
class PKDarkCardProfileSkeleton extends StatefulWidget {
  final bool isCircularImage;
  final bool isBottomLinesActive;
  PKDarkCardProfileSkeleton({this.isCircularImage = true, this.isBottomLinesActive = true});
  @override
  _PKDarkCardProfileSkeletonState createState() => _PKDarkCardProfileSkeletonState();
}

class _PKDarkCardProfileSkeletonState extends State<PKDarkCardProfileSkeleton> with SingleTickerProviderStateMixin {
  AnimationController? _controller;
  Animation<double>? animation;
...
class _PKCardPageSkeletonState extends State<PKCardPageSkeleton> with SingleTickerProviderStateMixin {
  AnimationController? _controller;
  Animation<double>? animation;
...
class _PKDarkCardPageSkeletonState extends State<PKDarkCardPageSkeleton> with SingleTickerProviderStateMixin {
  AnimationController? _controller;
  Animation<double>? animation;
